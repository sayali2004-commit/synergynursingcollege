  ...
  return (
    <footer className="relative overflow-hidden bg-[#122D42] text-white/75">
      <div
        ...
        aria-hidden="true"
      />
      <div className="container-x flex flex-col items-center gap-8 pl-12 pr-8 py-10 sm:flex-row sm:justify-between sm:items-start sm:gap-8 sm:pl-24 sm:pr-16 lg:py-12">
        {/* Contact */}
        <div>
